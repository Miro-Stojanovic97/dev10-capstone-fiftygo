...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                ...
                .antMatchers(HttpMethod.GET, "/api/type", "/api/type/*").hasAnyRole("USER", "PREMIUM", "ADMIN")
                .antMatchers(HttpMethod.POST, "/api/type").hasAnyRole("USER", "PREMIUM", "ADMIN")
                .antMatchers(HttpMethod.PUT, "/api/type/*").hasAnyRole("USER", "PREMIUM", "ADMIN")
                .antMatchers(HttpMethod.DELETE, "/api/type/*").hasAnyRole("ADMIN")
                .antMatchers("/**").denyAll()
                .and()
