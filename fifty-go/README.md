...
* [x] Create base package (fifty-go)
   ...
   * [x] Create domain package
     ...
     * [x] Create UserService class (1 hour)
         * [x] mark with @Service
     ...
     * [x] Create TripService class (2 hours)
         * [x] mark as @Service
         * [x] add @Autowired TripRepo tRepo field variable
         * [x] add @Autowired ActivityRepo aRepo field variable
         * [x] add @Autowired UserRepo uRepo field variable
         * [x] -- should have autogenerated getTrips method from controller --
             * [x] return repo.findAll();
         * [x] create public void deleteById(Integer tripId, Principal user) throws InvalidUserException {
             * [x] Trip toDelete = tripRepo.findById(tripId);
             ...
             * [x] if( requester.getRoles().contains("ADMIN") || requester.getUserId().intValue() == toDelete.getUserId().intValue() ){
                 * [x] tRepo.remove(tripId);
             * [x] } else { throw new InvalidUserException("Only admins and the author of the trip may delete it."); }
     * [x] Create TripService class (2 hours)
         * [x] mark as @Service
         * [x] add @Autowired ActivityRepo tRepo field variable
         * [x] add @Autowired UserRepo uRepo field variable
         * [ \x] -- should have autogenerated getActivities method from controller --
             * [ ] return repo.findAll();
         * [x] create public void deleteById(Integer activityId, Principal user) throws InvalidUserException {
             * [x] Trip toDelete = activityRepo.findById(activityId);
             * [x] AppUser requester = uRepo.findByUsername(user.getName());
   ...
   * [x] Create controllers package
     * [x] Add AuthController class (30 min)
     ...
     * [x] Add PinController class (1 hour)
         * [x] mark as @RestController
     ...
     * [ ] Add TripController class (2 hours)
         * [x] mark as @RestController
         * [x] @RequestMapping( "/api/trip" )
         * [x] add @Autowired TripService field variable (service)
         * [x] add a GET endpoint ("/public") for retrieving all Trips
             * [x] List&lt;Trip&gt; pubTrips = service.getPublicTrips() (doesn't exist yet...)
             * [x] generate TripService.getPublicTrips()
             * [x] return ResponseEntity.ok(pubTrips);
         * [x] add a DELETE endpoint ("/{tripId}")
             * [x] public ResponseEntity delete( @PathVariable Integer tripId, Principal user ){
                 * [x] service.deleteById( tripId, user );
                 * [x] generate tripService.deleteById()
                 * [x] return ResponseEntity.ok().build();
     * [x] Add CityController class (1 hour)
         * [x] mark as @RestController
   ...
   * [x] Create mysql schemas (test/prod) (4 hours)
       ...
       * [x] insert data into tables for test db: (3 hours)
   ...
   * [x] Create React Front-End. Do a few components each day. Should take 1-4 hours per component.
